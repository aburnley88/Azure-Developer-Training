...
namespace topic_send
{
    class Program
    {
        private static string _bus_connectionstring = "Endpoint=sb://serbusburnley.servicebus.windows.net/;SharedAccessKeyName=topicpolicy;SharedAccessKey=QAwSyseHrulAwj5Xb1CMDPqQVLnTJxLwXvY5Sm6g3GU=";
        private static string _management_connection_string = "Endpoint=sb://serbusburnley.servicebus.windows.net/;SharedAccessKeyName=topicmanagement;SharedAccessKey=g1gzOqd3xyHcd/EkQjmBs9RNVSu03UrtKhgmV5pnppg=;EntityPath=apptopic";
