...
namespace topic___receive
{
    class Program
    {
        private static string _bus_connectionstring = "Endpoint=sb://serbusburnley.servicebus.windows.net/;SharedAccessKeyName=topicpolicy;SharedAccessKey=QAwSyseHrulAwj5Xb1CMDPqQVLnTJxLwXvY5Sm6g3GU=;EntityPath=apptopic";
